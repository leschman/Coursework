...
female('Duchess Sarah').
female('Duchess Camilla').
female('Princess Beatrice').
female('Princess Eugenie').
female('Countess Sophie').
female('Lady Louise').
...
born('Duchess Camilla', 1947).
born('Prince Charles', 1948).
born('Duchess Sarah', 1959).
born('Prince Andrew', 1960).
born('Prince Edward', 1964).
born('Princess Sophie', 1965).
born('Prince William', 1982).
born('Prince Henry', 1984).
born('Princess Beatrice', 1988).
born('Princess Euginie', 1990).
born('Lady Louise', 2003).
born('Viscount James', 2007).
...
married('Prince Charles', 'Duchess Camilla').
married('Prince William', 'Catherine Middleton').
married('Prince Andrew', 'Duchess Sarah').
married('Prince Edward', 'Countess Sophie').
...
parent('Duchess Sarah', 'Princess Eugenie').
parent('Prince Andrew', 'Princess Beatrice').
parent('Duchess Sarah', 'Princess Beatrice').
parent('Prince Edward', 'Lady Louise').
parent('Prince Edward', 'Viscount James').
parent('Countess Sophie', 'Lady Louise').
parent('Countess Sophie', 'Viscount James').
