        ...
        while (!done) {
            ...
            if (choice == 0) {
                ...
                int roomNum = Integer.parseInt(JOptionPane.showInputDialog("Discharge from Room Number (0-1): "));
                        ...
                        treatmentRooms[roomNum].sendToRoom(priorityQueues.delete());
